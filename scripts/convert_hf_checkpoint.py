...
def convert_hf_checkpoint(
    *,
    ...
    if not isinstance(bin_index, dict) or "weight_map" not in bin_index:
        raise ValueError(f"Invalid model index '{model_map_json}': Missing 'weight_map' dictionary.")
    if not isinstance(bin_index["weight_map"], dict):
        raise ValueError(f"Invalid model index '{model_map_json}': 'weight_map' must be a dictionary.")
